...
conda create --yes -q -n python${python_version} -c salilab -c conda-forge python=${python_version} pip biopython networkx dill pandas imp-nightly eigen swig cmake
